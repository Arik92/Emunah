app.service('ytService', function($http) {
  ...
  serv.getAllPlayLists = function() {
    ...
    return $http.get('https://www.googleapis.com/youtube/v3/playlists?part=snippet&maxResults=50&channelId=UCtAh700VTIQb5Wsx_vdg-Pw&key=AIzaSyCLT_rwCcNUqfBEU0FRm2hoBhMkReIUFJ').then(function(response){
